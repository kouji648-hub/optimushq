  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-gray-900 min-h-screen">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="text-center text-2xl font-bold tracking-tight text-white">{t('login.title')}</h2>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-100">{t('login.username')}</label>
            <div className="mt-2">
              <input
                type="text"
                value={username}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-100">{t('login.password')}</label>
            <div className="mt-2">
              <input
                type="password"
                value={password}
