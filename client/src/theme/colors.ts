// Tailwind CSS color palette RGB values for all 17 non-gray colors
// Each shade maps to "r g b" string for use with CSS custom properties
...
export const THEME_COLORS: Record<ThemeColorName, Record<number, string>> = {
  red: {
...
export function applyThemeColor(name: ThemeColorName): void {
